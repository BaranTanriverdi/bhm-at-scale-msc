...
// Increased to 300k to support "First Run" full scans with GPT-5.1 (400k context).
// We reserve ~100k for system prompts, history, and reasoning.
const MAX_EVIDENCE_TOKENS = 300000;
...
export async function formatEvidenceForPrompt(bundle: AnalysisBundle): Promise<string> {
  ...
  let remainingTokens = MAX_EVIDENCE_TOKENS - signalsTokens;
